...
/**
 *
 * @author Equipo 03 Interfaz DAO para la gestión de Movimientos. Define los
 * métodos necesarios para realizar operaciones CRUD sobre movimientos.
 */
public interface MovimientoDAO {
     ...
     *
     * @return Una lista con todos los movimientos. Retorna una lista vacía si
     * no hay movimientos. 
     */
