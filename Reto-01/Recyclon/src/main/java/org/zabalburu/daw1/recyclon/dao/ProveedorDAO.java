 ...
 *
 * @author Equipo 03
 * Interfaz DAO para la gestión de proveedores.
 * Define los métodos necesarios para realizar operaciones CRUD sobre los proveedores.
 */
public interface ProveedorDAO {
    /**
     * Obtiene la lista completa de todos los Proveedores registrados.
     * 
     * @return Una lista con todos los Proveedores. Retorna una lista vacía si no hay Proveedores.
     */
     ...
     * Obtiene la lista completa de todos los proveedores registrados.
     * 
     * @return Una lista con todos los proveedores. Retorna una lista vacía si no hay clientes.
     */
